...
public class Chapitre2CoreJava2 {
  ...
  public static List<String> listeDesMots() {
    List<String> liste = /* SOLUTION;null;// À compléter*/
        new LinkedList<String>(); /* FIN SOLUTION */
  ...
  /**
   * Obtention d'une liste de couples <String,Integer>, à chaque mot de la liste listeDeMots, est
   * associé son nombre d'occurrence
   *

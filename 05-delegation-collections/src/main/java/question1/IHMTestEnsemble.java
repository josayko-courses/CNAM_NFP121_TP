...
public class IHMTestEnsemble extends JFrame {
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    button1.addActionListener((ActionEvent ae) -> unionActionPerformed(ae));

    panel3.add(button1);
    button2 = new JButton("intersection");
    button2.setBackground(java.awt.Color.yellow);
    button2.setName("intersection");
    button2.addActionListener((ActionEvent ae) -> intersectionActionPerformed(ae));
    ...
    button3.addActionListener((ActionEvent ae) -> differenceActionPerformed(ae));

    panel3.add(button3);
    button4 = new JButton("diffSymetrique");
    button4.setBackground(java.awt.Color.cyan);
    button4.setName("diffSymetrique");
    button4.addActionListener((ActionEvent ae) -> diffSymetriqueActionPerformed(ae));
  ...
  private void differenceActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_differenceActionPerformed
  ...
  private void intersectionActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_intersectionActionPerformed
    // Add your handling code here:
    Ensemble<String> e1 = getSet(textField1);
    Ensemble<String> e2 = getSet(textField2);
  ...
  private void unionActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_unionActionPerformed
    Ensemble<String> e1 = getSet(textField1);
    Ensemble<String> e2 = getSet(textField2);
    textField3.setText(e1.union(e2).toString());
  } // GEN-LAST:event_unionActionPerformed

  private void diffSymetriqueActionPerformed(

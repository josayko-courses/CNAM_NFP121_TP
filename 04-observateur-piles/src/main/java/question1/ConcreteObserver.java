...
public class ConcreteObserver implements Observer {
  ...
  /**
   * implémentation de la seule méthode de l'interface java.util.Observer à chaque exécution de
   * cette méthode, celle-ci se contente d'empiler les paramètres transmis observable et arg
   * respectivement dans 2 piles senders et arguments
   */

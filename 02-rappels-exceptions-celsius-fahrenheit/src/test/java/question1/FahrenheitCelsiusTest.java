...
public class FahrenheitCelsiusTest {
   ...
   * méthodes doivent
   * vérifier les résultats attendus à l'aide d'assertions assertXXX. Par
   * convention, leurs noms
   * devraient débuter par "test". Les IDE permettre d'ébaucher les méthodes de
   * tests. Exemple: dans
   * eclipse: clique droit sur la classe / new / Junit test / s'assurer que la
   * classe va bien être

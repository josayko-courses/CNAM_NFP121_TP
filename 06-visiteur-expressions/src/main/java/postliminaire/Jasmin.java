...
public class Jasmin {
  ...
  public static void exec(String nomDeClasse) throws Exception {
    ...
    System.out.println("called: " + methode);
  ...
  private static class MyClassLoader extends ClassLoader {
    ...
    protected synchronized Class<?> loadClass(String name, boolean resolve)
      ...
      Class classe =
          classes.get(name); //  ou bien sans classes, Class classe = findLoadedClass(name);
      if (classe == null) {
        ...
        if (classe == null) throw new ClassNotFoundException(name);
